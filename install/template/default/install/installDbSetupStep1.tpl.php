        ...
        <form action="" method="post" class="install-setup-form">
            <div class="input-row">
                <div class="input-field">
                    ...
                    <input type="text" name="db_name" id="db_name" value="heanes.com" class="install-normal-input" title="数据库名" placeholder="数据库名" required readonly/>
                </div>
            ...
            <div class="input-row">
                <div class="input-field">
                    ...
                    <input type="text" name="db_user" id="db_user" value="root" class="install-normal-input" title="用户名<" placeholder="用户名" required readonly/>
                </div>
                <div class="input-tips">
            ...
            <div class="input-row">
                <div class="input-field">
                    ...
                    <input type="text" name="db_host" id="db_host" value="localhost" class="install-normal-input" title="数据库主机" placeholder="localhost" required readonly/>
                </div>
                <div class="input-tips">
            ...
            <div class="input-row">
                <div class="input-field">
                    ...
                    <input type="text" name="db_port" id="db_port" value="3307" class="install-normal-input" title="数据库端口" placeholder="3306" required readonly/>
                </div>
                <div class="input-tips">
            ...
            <div class="input-row">
                <div class="input-field">
                    ...
                    <input type="text" name="db_table_pre" id="db_table_pre" class="install-normal-input" title="表前缀" placeholder="pre_" value="pre_" required readonly/>
                </div>
                <div class="input-tips">
                    <span class="tips">将系统安装到哪个数据库？</span>
                </div>
