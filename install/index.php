 ...
 * @author Heanes
 * @time 2015-05-11 22:45:43
 */
define('APP_ID','install');
...
if (!@include(PATH_ABS_BASE_APP.'controller/BaseInstallController.class.php')) exit('BaseInstallController.class.php isn\'t exists!');
Base::run();
Debug::display_debug();