...
create table `pre_navigation` (
    ...
    `img_src_hover`                 varchar(255) comment '导航链接图标鼠标浮上时地址',
    `img_src_active`                varchar(255) comment '导航链接激活时图标地址',
    `href_active_match_controller`  text comment '链接激活匹配的控制器',
    `style_class`                   text comment '链接样式',
    `style_class_hover`             text comment '链接鼠标浮上时样式',
    `style_class_acitve`            text comment '链接激活的样式',
    `order_number`                  int unsigned comment '排序序号',
    `is_enable`                     tinyint unsigned default 1 comment '是否启用（显示）',
    `is_deleted`                    tinyint unsigned default 0 comment '是否删除',
    `insert_time`                   int(10) unsigned comment '导航创建时间',
    `update_time`                   int(10) unsigned comment '导航更新时间',
...
create table `pre_slide` (
    ...
    `is_enable`     tinyint unsigned default 1 comment '是否启用（显示）',
    `is_deleted`    tinyint unsigned default 0 comment '是否删除',
    `insert_time`   int(10) unsigned comment '幻灯创建时间',
    `update_time`   int(10) unsigned comment '幻灯最后修改时间',
    `create_user`   int unsigned comment '创建人',
    `update_user`   int unsigned comment '更新人',
    primary key (`id`)
)
