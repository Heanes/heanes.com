...
create table `pre_users` (
    ...
    `reg_time`              int(10) unsigned comment '用户注册时间',
    `reg_ip`                varchar(255) comment '用户注册IP',
    `current_login_ip`      varchar(255) comment '用户当前登陆IP',
    `last_login_ip`         varchar(255) comment '用户最后登陆IP',
    `current_login_time`    int(10) unsigned comment '用户当前登陆时间',
    `last_login_time`       int(10) unsigned comment '用户最后登陆时间',
...
create table `pre_user_login_log` (
    ...
    `login_time`    int(10) unsigned comment '用户登陆时间',
