...
create table `pre_article` (
    ...
    `insert_time`       int(10) unsigned comment '文章创建时间',
    `update_time`       int(10) unsigned comment '文章更新时间',
    `create_user`       int unsigned comment '创建人',
    `update_user`       int unsigned comment '更新人',
    primary key (`id`)
)
...
create table `pre_article_comment`(
    ...
    `insert_time` int(10) unsigned comment '评论时间',
    `update_time` int(10) unsigned comment '评论更新时间',
    `create_user` int unsigned comment '创建人',
    `update_user` int unsigned comment '更新人',
    primary key (`id`)
)
...
create table `pre_article_praise`(
    ...
    `is_enable`     tinyint unsigned default 1 comment '是否启用（显示）',
    `is_deleted`    tinyint unsigned default 0 comment '是否已删除',
    `insert_time`   int(10) unsigned comment '点赞时间',
    `update_time`   int(10) unsigned comment '更新时间',
    `create_user`   int unsigned comment '创建人',
    `update_user`   int unsigned comment '更新人',
    primary key (`id`)
...
create table `pre_article_comment_judge`(
    ...
    `is_enable`             tinyint unsigned default 1 comment '是否有效',
    `is_deleted`            tinyint unsigned default 0 comment '是否已删除',
    `insert_time`           int(10) unsigned comment '操作时间',
    `update_time`           int(10) unsigned comment '更新时间',
    `create_user`           int unsigned comment '创建人',
    `update_user`           int unsigned comment '更新人',
    primary key (`id`)
...
create table `pre_article_album` (
    ...
    `is_enable`     tinyint unsigned default 1 comment '是否启用',
    `is_deleted`    tinyint unsigned default 0 comment '是否删除',
    `insert_time`   int(10) unsigned comment '图片添加时间',
    `update_time`   int(10) unsigned comment '图片更新时间',
    `create_user`   int unsigned comment '创建人',
    `update_user`   int unsigned comment '更新人',
    primary key (`id`)
)
