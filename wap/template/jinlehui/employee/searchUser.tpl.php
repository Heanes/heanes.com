				...
				<ul class="result-block-ul default-background">
					...
					<?php } else {
						foreach ($output['userList'] as $key => $user) { ?>
							<li>
								<a class="block-href" href="<?php echo BASE_URL; ?>index.php?act=employee&op=addFromExistsUser&user_id=<?php echo $user['id'];?>">
...
<script type="text/javascript">
	$('#search_user').on('click', function () {
		...
		if (keywords == '') {
			...
			window.location = '<?php echo BASE_URL; ?>index.php?act=employee&op=addFromExistsUser&keywords=' + keywords;
		}
	});
</script>
