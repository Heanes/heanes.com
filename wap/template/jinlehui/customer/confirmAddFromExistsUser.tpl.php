		...
		<div class="search-result-list-block">
			<div class="result-block">
				<ul class="result-block-ul default-background">
					<li>
						<a class="block-href" href="<?php echo BASE_URL; ?>index.php?act=customer&op=addFromExistsUser&user_id=<?php echo $output['user']['id']; ?>">
			...
			<div class="operate-result-fail">
				...
				<div class="operate-result-jump">
					<ul class="jump-ul">
						...
						<li>
							<form action="<?php echo BASE_URL; ?>index.php?act=customer&op=_addFromExistsUser" method="post">
