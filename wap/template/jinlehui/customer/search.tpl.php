...
<div class="main-content w-wrap">
	<div class="page-nav-tab">
		<ul>
			...
			<li class="active"><a href="<?php echo BASE_URL; ?>index.php?act=customer&op=add">搜索结果</a></li>
		</ul>
	</div>
	<!-- S 搜索关键词输入 S -->
			...
			<ul class="result-block-ul default-background">
				...
				<?php } else {
					foreach ($output['userList'] as $key => $user) { ?>
						<li>
							<a class="block-href" href="<?php echo BASE_URL; ?>index.php?act=customer&op=show&user_id=<?php echo $user['id'];?>">
