...
<div class="main-content w-wrap">
	<div class="data-detail-block">
		<form action="<?php echo BASE_URL; ?>index.php?act=customer&op=updateCheck&id=<?php echo $output['customer']['id'];?>" method="post">
			<input type="hidden" name="id" value="<?php echo $output['customer']['id']; ?>" />
			<!-- 业务员信息 -->
			...
			<table class="data-detail-table">
				...
				<tr>
					<th>姓名：</th>
					<td><span><?php echo $output['customer']['user_master']['user_name']; ?></span></td>
				</tr>
				<tr>
					<th>性别：</th>
					<td>
						<?php if (!isset($output['customer']['user_master']['gender']) || empty($output['customer']['user_master']['gender'])) { ?>未知<?php } elseif ($output['customer']['user_master']['gender'] == 1) { ?>男<?php } elseif ($output['customer']['user_master']['gender'] == 0) { ?>女<?php } ?>
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
					<td><?php echo $output['customer']['user_master']['mobile']; ?></td>
				</tr>
				<tr>
					<th>部门</th>
					<td><?php echo $output['customer']['user_master']['department']['name']; ?></td>
				</tr>
				</tbody>
			</table>
			<!-- 用户信息 -->
			<table class="data-detail-table">
				...
				<tr>
					<th>姓名：</th>
					<td><span><?php echo $output['customer']['user_slave']['user_name']; ?></span></td>
				</tr>
				<tr>
					<th>性别：</th>
					<td>
						<span><?php if ($output['customer']['user_slave']['gender'] == 0) { ?>女<?php } elseif ($output['customer']['user_slave']['gender'] == 1) { ?>男<?php } else { ?>保密<?php } ?></span>
					</td>
				</tr>
				<tr>
					<th>联系电话：</th>
					<td><?php echo $output['customer']['user_slave']['mobile']; ?></td>
				</tr>
				<tr>
					<th>身份证号：</th>
					<td><?php echo $output['customer']['user_slave']['idcard']; ?></td>
				</tr>
				</tbody>
			</table>
			<!-- 用户认证信息 -->
