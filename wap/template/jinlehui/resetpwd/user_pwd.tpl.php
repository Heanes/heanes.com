<div class="main-content w-wrap">
	<div class="page-nav-tab">
		<ul>
			...
			<li class="active"><a href="<?php echo BASE_URL; ?>index.php?act=resetpwd&op=update">修改密码</a></li>
		</ul>
	</div>
	<div class="page-nav-tab">
		<ul>
	...
	<div class="reg-block">
		<form action="<?php echo BASE_URL; ?>index.php?act=resetpwd&op=user_edit" method="post" name="reg_form" id="reg_form">
