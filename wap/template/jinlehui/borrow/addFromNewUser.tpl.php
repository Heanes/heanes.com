...
<div class="main-content w-wrap">
	<div class="data-edit-block">
		<!-- 带输入验证的步骤提交 -->
		<form action="<?php echo BASE_URL; ?>index.php?act=borrow&op=addFromNewUser" method="post" id="add_borrow_data_form" enctype="multipart/form-data">
			<!-- 1.1基本文字型输入数据 -->
...
<!--							<p class="input-tip input-error-notice">请填写真实姓名</p>-->
			...
			<div class="data-edit-handle">
				...
				<div class="handle-right">
					...
					<input type="submit" name="add_borrow_data_form" class="data-submit-button" style="display:none;" value="保存" />
				</div>
			</div>
		</form>
	</div>
