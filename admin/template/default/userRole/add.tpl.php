<form action="<?php echo BASE_URL;?>index.php?act=UserRole&op=insert" method="post" class="input-condensed" onsubmit="javascript:return chk();" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加用户角色</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				<th>角色名称</th>
				<td colspan='4'><input type="text" name="role_name" value="" ></td>
			</tr>
			<tr>
				<th>添加时间</th>
	...
	<table id="list-table" cellspacing="1">
		...
		<tr class="chosen_tr">
			...
			<?php foreach ($privilegeUrl['_method'] as $sub_key => $sub_privilege) {?>
				<div style="width:180px;float:left;">
					<input class="checkbox" type="checkbox" value="<?php echo $sub_privilege['id']?>" name="action_code[]">
		...
		<?php }?>
		<tr><td colspan='4'><input class="checkbox" id="all" type="checkbox"  value="checkbox" name="chkGroup" onclick="checkAll();">全选</td></tr>
	</table>
	<br/>
	<script>
	function chk(){
