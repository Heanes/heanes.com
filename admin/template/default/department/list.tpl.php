...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=department&op=add" class="btn btn-primary btn-large">添加部门</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<th>
				<a href="javascript:sortBy('name', 'DESC');" title="点击对列表排序">名称<em class="triangle-down"></em></a>
			</th>
			<th>
				<a href="javascript:sortBy('english_name', 'DESC');" title="点击对列表排序">英文名称<em class="triangle-up"></em></a>
			</th>
			<th>
		...
		<tbody>
		<?php if(empty($output['department_list'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['department_list'] as $key=>$department) { ?>
		<tr>
			<td style="text-align:center;"><input name="check" type="checkbox"></td>
			<td style="text-align:center;"><?php echo $department['id'];?></td>
			...
			<td style="text-align:center;">
				...
				<a href="javascript:del('department', <?php echo $department['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
