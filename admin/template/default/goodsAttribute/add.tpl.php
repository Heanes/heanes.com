<form action="<?php echo BASE_URL;?>index.php?act=GoodsAttribute&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tbody>
			...
			<tr>
				<th>允许上传的文件类型</th>
				<td><input type="text" name="accept_type" value="" style="width:60%;"/></td>
				<th>值的单位</th>
