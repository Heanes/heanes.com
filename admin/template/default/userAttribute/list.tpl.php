...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=UserAttribute&op=add" class="btn btn-primary btn-large">添加用户额外属性</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<th>
				<a href="javascript:listTable.sort('name', 'DESC');" title="点击对列表排序">注册项名称<em class="triangle-down"></em></a>
			</th>
			<th>
				<a href="javascript:listTable.sort('input_type', 'DESC');" title="点击对列表排序">注册项输入类型<em class="triangle-down"></em></a>
			</th>
			<th>
				<a href="javascript:listTable.sort('add_show', 'DESC');" title="点击对列表排序">注册时是否显示此项<em class="triangle-down"></em></a>
			</th>
			<th>
		...
		<tbody>
		<?php if(empty($output['userFields_list'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['userFields_list'] as $key=>$userFields) { ?>
		<tr>
			<td style="text-align:center;"><input name="check" type="checkbox"></td>
			<td style="text-align:center;"><?php echo $userFields['id'];?></td>
			<td style="text-align:center;"><a href="<?php echo BASE_URL;?>index.php?act=UserAttribute&op=edit&id=<?php echo $userFields['id'];?>"><?php echo $userFields['name'];?></a></td>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=UserAttribute&op=edit&id=<?php echo $userFields['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('user_fields', <?php echo $userFields['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
