...
<body>
	<div class="wrap">
		...
		<div class="right_corner_nav">
			...
			<button class="self-icon-reload" onclick="window.location.reload();" title="刷新本页"></button>
	...
	<cite>
		<!-- js S -->
		<script type="text/javascript" src="/public/static/libs/js/jquery/2.1.3/jquery-2.1.3.min.js"></script>
