...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=UserProperty&op=add" class="btn btn-primary btn-large">添加用户财产</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tbody>
		<?php if(empty($output['userProperty_list'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['userProperty_list'] as $key=>$userProperty) { ?>
		<tr>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=UserProperty&op=edit&id=<?php echo $userProperty['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('user_property', <?php echo $userProperty['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
