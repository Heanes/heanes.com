<form action="<?php echo BASE_URL;?>index.php?act=PrivilegeUrl&op=insert" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加功能权限存储库</td>
			</tr>
		</thead>
		<tbody>
			<tr>
				...
				<th>权限名称</th>
				<td><input type="text" name="privilege_name" value="" style="width: 60%;"></td>
			</tr>
			<tr>
				<th>控制器类名</th>
				<td><input type="text" name="class_name" value="" style="width: 60%;"></td>
				<th>方法名</th>
				<td><input type="text" name="method" value="" style="width: 60%;"></td>
			</tr>
			<tr>
				<th>添加时间</th>
