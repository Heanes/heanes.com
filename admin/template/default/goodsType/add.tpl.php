<form action="<?php echo BASE_URL;?>index.php?act=GoodsType&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加商品类型</td>
			</tr>
		</thead>
		<tbody>
			<tr>
...
<style>
	.btn-add {
	    background: url("image/formstyle/bg_position.gif") 0 -718px;
		float: left;
	    padding-left: 19px;
	    margin-left:20px;
	    color: #09c;
