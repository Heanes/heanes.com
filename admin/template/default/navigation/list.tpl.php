...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=navigation&op=add" class="btn btn-primary btn-large">添加网站导航栏</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['navigation_list'] as $key=>$navigation) { ?>
		<tr>
			<td style="text-align:center;"><input name="check" type="checkbox"></td>
			<td style="text-align:center;"><?php echo $navigation['id'];?></td>
			<td style="text-align:center;"><a href="<?php echo BASE_URL;?>index.php?act=navigation&op=edit&id=<?php echo $navigation['id'];?>"><?php echo $navigation['name'];?></a></td>
			<td style="text-align:center;"><?php echo $navigation['a_href'];?></td>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=navigation&op=edit&id=<?php echo $navigation['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('navigation', <?php echo $navigation['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
