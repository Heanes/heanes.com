...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=PropertyAttribute&op=add" class="btn btn-primary btn-large">添加产品属性名称</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<th>
				<a href="javascript:listTable.sort('name', 'DESC');" title="点击对列表排序">资产类型属性名称<em class="triangle-down"></em></a>
			</th>
			<th>
				<a href="javascript:listTable.sort('input_type', 'DESC');" title="点击对列表排序">输入方式<em class="triangle-down"></em></a>
			</th>
			<th>
		...
		<tbody>
		<?php if(empty($output['propertyFields_list'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['propertyFields_list'] as $key=>$propertyFields) { ?>
		<tr>
			<td style="text-align:center;"><input name="check" type="checkbox"></td>
			<td style="text-align:center;"><?php echo $propertyFields['id'];?></td>
			<td style="text-align:center;"><?php echo $propertyFields['property_name'];?></td>
			<td style="text-align:center;"><a href="<?php echo BASE_URL;?>index.php?act=PropertyAttribute&op=edit&id=<?php echo $propertyFields['id'];?>"><?php echo $propertyFields['name'];?></a></td>
			<td style="text-align:center;"><?php echo $propertyFields['input_type'];?></td>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=PropertyAttribute&op=edit&id=<?php echo $propertyFields['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('property_fields', <?php echo $propertyFields['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
