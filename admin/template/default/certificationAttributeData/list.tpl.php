...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=CertificationAttributeData&op=add" class="btn btn-primary btn-large">添加认证属性映射</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tbody>
		<?php if(empty($output['certificationFieldsData_list'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['certificationFieldsData_list'] as $key=>$certificationFieldsData) { ?>
		<tr>
			<td style="text-align:center;"><input name="check" type="checkbox"></td>
			<td style="text-align:center;"><?php echo $certificationFieldsData['id'];?></td>
			...
			<td style="text-align:center;">
				...
				<a href="javascript:del('user_certification_fields_data', <?php echo $certificationFieldsData['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
