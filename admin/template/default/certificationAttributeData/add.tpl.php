<form action="<?php echo BASE_URL;?>index.php?act=CertificationAttributeData&op=insert" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加认证属性映射</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td>
					<select name="fields_id">
						...
						<option value ="<?php echo $certificationFields['id'];?>"><?php echo $certificationFields['name'];?></option>
						<?php }?>
					</select>
				</td>
				<th>用户ID</th>
