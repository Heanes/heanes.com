<form action="<?php echo BASE_URL;?>index.php?act=FileType&op=insert" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加文件类型</td>
			</tr>
		</thead>
		<tbody>
			<tr>
				<th>内部ID</th>
				<td colspan="4"><input type="text" disabled="disabled" value="<?php echo $output['lastID'];?>"></td>
			</tr>
			<tr>
				<th><span class="need">*</span>文件类型名称</th>
				<td><input type="text" name="type_name" value="" style="width:60%;"></td>
				<th>文件类型描述</th>
				<td><input type="text" name="type_des" value="" style="width:60%;"/></td>
			</tr>
			<tr>
				<th>是否启用</th>
				<td colspan="4">
