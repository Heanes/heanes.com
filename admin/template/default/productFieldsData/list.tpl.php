...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=ProductFieldsData&op=add" class="btn btn-primary btn-large">添加产品属性映射</a>
	</div>
</div>
<!-- 数据列表 S -->
	...
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=ProductFieldsData&op=edit&id=<?php echo $productFieldsData['id'];?>" class="btn btn-mini">编辑</a>
