<form action="<?php echo BASE_URL;?>index.php?act=UserAttributeData&op=insert" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tbody>
			...
			<tr>
				<th>插入时间</th>
				<td><input type="text" name="insert_time" id="insert_time" value="<?php echo to_date('now');?>" placeholder="选择注册时间" onclick="$.calendar({format:'yyyy-MM-dd HH:mm:ss'});" class="date_time_picker"/></td>
				<th>更新时间</th>
