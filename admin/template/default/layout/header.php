		...
		<div class="header">
			...
			<div class="admin_layout_head">
				...
				<div class="head_welcome">
					<div class="welcome_str">{$session.admin_name}，欢迎你</div>
					<div class="welcom_info">今天是<span id="js_time_now"></span></div>
				</div>
				<div class="head_quick_handle">
					<a href="javascirpt:;">消息<span class="admin_message_nums">5</span></a>
					...
					<a href="../login.html" id="log_out" title="安全退出" target="_parent"><img src="../image/layout/head/logout.png"></a>
				</div>
				<div class="tool_bar">
					<div class="nav_handle_left">
						...
						<a href="../index.html" target="_parent"><img id="nav_default_page" alt="起始页" src="../image/layout/toolbar/admin_home.png" title="起始页"></a>
					</div>
