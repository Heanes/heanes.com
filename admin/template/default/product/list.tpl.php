...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=Product&op=add" class="btn btn-primary btn-large">添加产品基本信息</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<th>
				<a href="javascript:listTable.sort('name', 'DESC');" title="点击对列表排序">产品名称<em class="triangle-down"></em></a>
			</th>
			<th>
				<a href="javascript:listTable.sort('category_id', 'DESC');" title="点击对列表排序">产品分类ID<em class="triangle-down"></em></a>
			</th>
			<th>
		...
		<tr>
			...
			<td style="text-align:center;"><a href="<?php echo BASE_URL;?>index.php?act=Product&op=edit&id=<?php echo $product['id'];?>"><?php echo $product['name'];?></a></td>
			<td style="text-align:center;"><?php echo $product['category_name'];?></td>
			<td style="text-align:center;"><?php echo $product['type_name'];?></td>
			<td style="text-align:center;"><?php echo $product['shop_price'];?></td>
			<td style="text-align:center;"><?php echo $product['market_price'];?></td>
			<td style="text-align:center;"><?php echo $product['store_num'];?></td>
			<td style="text-align:center;"><?php echo $product['total_sold_num'];?></td>
			<td style="text-align:center;"><?php echo $product['user_role_name'];?></td>
			<td style="text-align:center;"><?php echo $product['user_rank'];?></td>
			<td style="text-align:center;"><?php echo to_date($product['create_time']);?></td>
			<td style="text-align:center;"><?php echo to_date($product['update_time']);?></td>
			<td style="text-align:center;"><?php echo $product['is_enable']==1?'显示':'不显示';?></td>
			<td style="text-align:center;"><?php echo $product['is_delete']==1?'是':'否';?></td>
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=Product&op=edit&id=<?php echo $product['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('product', <?php echo $product['id'];?>,true,'product',false);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
