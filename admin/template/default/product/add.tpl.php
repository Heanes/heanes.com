<form action="<?php echo BASE_URL;?>index.php?act=Product&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
<!-- Tab样式编辑修改 -->
		...
		<table class="table table-striped table-condensed table-data-edit">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="product_name" value="" datatype="s2-10" errormsg="产品名称至少2个字符,最多10个字符！" style="width:60%;" />
						<span class="Validform_checktip"></span>
					</td>
					<th><span class="need">*</span>产品分类名称</th>
					<td>
						<select name="category_id" datatype="*" nullmsg="请选择产品分类名称！">
				...
				<tr>
					<th>贷款类型</th>
					<td colspan="4">
						<textarea class="editor_id1" name="loan_type"></textarea>
