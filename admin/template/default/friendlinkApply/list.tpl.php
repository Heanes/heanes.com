...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=friendLinkapply&op=add" class="btn btn-primary btn-large">添加申请列表</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<th>
				<a href="javascript:sortBy('email', 'DESC');" title="点击对列表排序">链接Email<em class="triangle-up"></em></a>
			</th>
			<th>
				<a href="javascript:sortBy('a_href', 'DESC');" title="点击对列表排序">链接地址<em class="triangle-down"></em></a>
			</th>
			<th>
				<a href="javascript:sortBy('img_src', 'DESC');" title="点击对列表排序">链接图片地址<em class="triangle-down"></em></a>
			</th>
			<th>
			...
			<th>
				<a href="javascript:sortBy('status', 'DESC');" title="点击对列表排序">申请状态<em class="triangle-down"></em></a>
			</th>
		...
		<tbody>
		<?php if(empty($output['friendLinkApplyList'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['friendLinkApplyList'] as $key=>$friendLinkApply) { ?>
		<tr>
			<td style="text-align:center;"><input name="check" type="checkbox"></td>
			<td style="text-align:center;"><?php echo $friendLinkApply['id'];?></td>
			<td style="text-align:center;"><a href="<?php echo BASE_URL;?>index.php?act=friendLinkApply&op=edit&id=<?php echo $friendLinkApply['id'];?>"><?php echo $friendLinkApply['name'];?></a></td>
			<td style="text-align:center;"><?php echo $friendLinkApply['email'];?></td>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=friendLinkApply&op=edit&id=<?php echo $friendLinkApply['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('friend_link_apply', <?php echo $friendLinkApply['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
