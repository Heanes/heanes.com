...
<form action="<?php echo BASE_URL.'index.php?act=borrow&op=insert';?>" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tr>
			<th>业务主ID</th>
			<td><input type="text" name="uid_master" value="" style="width:100%;"></td>
			<th>业务客ID</th>
			<td><input type="text" name="uid_slave" value="" style="width:100%;"></td>
		</tr>
		<tr>
			<th>贷款用途（标识ID）</th>
			<td>
			...
			<th>贷款额度</th>
			<td><input type="text" name="total" value="" style="width:100%;"></td>
		</tr>
		<tr>
			<th>贷款年限</th>
			<td><input type="text" name="year_limit" value="" style="width:100%;"></td>
			<th>利息</th>
			<td><input type="text" name="rate" value="" style="width:100%;"></td>
		</tr>
		<tr>
			<th>贷款成功截止期限</th>
		...
		<tr>
			...
			<td>
				<select name="progress_status">
					<option value="">请选择</option>
					<option value ="1">下户</option>
					<option value ="2">评级</option>
					<option value ="3">做卷</option>
					<option value ="4">资料审核</option>
					<option value ="5">批贷函</option>
					<option value ="6">贷后管理（开始放款）</option>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td colspan="3" style="height:460px;padding:0;margin:0;">
				...
				<textarea name="usage_info" style="width:800px;height:600px;visibility:hidden;"></textarea>
