<form action="<?php echo BASE_URL;?>index.php?act=ProAttributeData&op=update" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tbody>
			...
			<tr>
				<th>产品属性值</th>
				<td colspan="4">
					<textarea class="editor_id1" name="fields_value"><?php echo $output['proFieldsData']['fields_value'];?></textarea>
