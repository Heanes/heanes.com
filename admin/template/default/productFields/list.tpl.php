...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=ProductFields&op=add" class="btn btn-primary btn-large">添加产品属性名称</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tr>
			...
			<td style="text-align:center;"><a href="<?php echo BASE_URL;?>index.php?act=ProductFields&op=edit&id=<?php echo $productFields['id'];?>"><?php echo $productFields['name'];?></a></td>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=ProductFields&op=edit&id=<?php echo $productFields['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:" onclick="listTable.remove()" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
