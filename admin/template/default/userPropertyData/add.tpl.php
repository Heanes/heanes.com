<form action="<?php echo BASE_URL;?>index.php?act=UserPropertyData&op=insert" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加用户额外注册项数据</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				<th>财产属性值</th>
				<td colspan='4'><input type="text" name="fields_value" value="" style="width: 25%;"></td>
			</tr>
			<tr>
				<th>添加时间</th>
