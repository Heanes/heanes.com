<form action="<?php echo BASE_URL;?>index.php?act=Ware&op=update" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	...
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tbody>
			...
			<tr>
				<th>物品添加时间</th>
				<td><input type="text" name="insert_time" value="<?php echo to_date($output['ware']['insert_time']);?>" placeholder="选择添加时间" onclick="$.calendar({format:'yyyy-MM-dd HH:mm:ss'});" class="date_time_picker"/></td>
				<th>物品更新时间</th>
