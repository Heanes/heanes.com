<form action="<?php echo BASE_URL;?>index.php?act=Ware&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
<!-- Tab样式编辑修改 -->
	...
	<dl id="data-edit-tab">
		...
		<table class="table table-striped table-condensed table-data-edit">
			...
			<tbody>
				...
				<tr>
					<th><span class="need">*</span>物品分类名称</th>
					<td>
						<select name="category_id" datatype="*" nullmsg="请选择物品分类名称！">
					...
					<td><input type="text" name="ware_name" value="" datatype="s2-10" errormsg="物品名称至少2个字符,最多10个字符！" style="width:60%;" />
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<th><span class="need">*</span>查看用户角色</th>
					<td>
			...
			<tr>
				...
				<td>
					<select name="fields_type_id" class="select-normal" id="selectid" onchange="checkOption();">
						...
						<option value ="<?php echo $wareType['id'];?>"><?php echo $wareType['name'];?></option>
						<?php }?>
					</select>
				</td>
			</tr>
