...
<form action="<?php echo BASE_URL.'index.php?act=bank&op=insert';?>" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tr>
			<th>上传时间</th>
			<td><input type="text" name="bank_create_time" value="<?php echo to_date('now');?>" placeholder="选择上传时间" onclick="$.calendar({format:'yyyy-MM-dd HH:mm:ss'});" class="date_time_picker"/></td>
			<th>更新时间</th>
