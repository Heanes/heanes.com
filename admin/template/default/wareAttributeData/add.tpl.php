<form action="<?php echo BASE_URL;?>index.php?act=WareAttributeData&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加物品属性映射</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td>
					<select name="fields_id" datatype="*" nullmsg="请选择属性名称！">
						...
						<option value ="<?php echo $wareFields['id'];?>"><?php echo $wareFields['name'];?></option>
						<?php }?>
					</select>
