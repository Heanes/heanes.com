	...
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tbody>
			...
			<tr>
				...
				<th>文章创建时间</th>
				<td><input type="text" name="article_create_time" id="article_create_time1" value="<?php echo to_date($output['article']['create_time']);?>" placeholder="选择起始时间" onclick="javascript:$.calendar({format:'yyyy-MM-dd HH:mm:ss'});" class="date_time_picker"/></td>
			</tr>
			<tr>
				<th>文章更新时间</th>
