...
<div class="data-list-href">
	<div class="handle-field">
		<a href="<?php echo BASE_URL;?>index.php?act=WareType&op=add" class="btn btn-primary btn-large">添加物品类型</a>
	</div>
</div>
<!-- 数据列表 S -->
<div class="data-list-table">
	<table class="table table-striped table-bordered table-condensed table-data-list">
		...
		<tbody>
		<?php if(empty($output['wareType_list'])){ ?>
		<tr><td>暂无内容</td></tr>
		<?php } ?>
		<?php foreach ($output['wareType_list'] as $key=>$wareType) { ?>
		<tr>
			...
			<td style="text-align:center;">
				<a href="<?php echo BASE_URL;?>index.php?act=WareType&op=edit&id=<?php echo $wareType['id'];?>" class="btn btn-mini">编辑</a>
				<a href="javascript:del('ware_type', <?php echo $wareType['id'];?>);" class="btn btn-mini btn-danger">删除</a>
			</td>
		</tr>
		<?php } ?>
		</tbody>
