<form action="<?php echo BASE_URL;?>index.php?act=WareType&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加物品类型</td>
			</tr>
		</thead>
		<tbody>
			<tr>
