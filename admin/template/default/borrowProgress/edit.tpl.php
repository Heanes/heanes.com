	...
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tbody>
			...
			<tr>
				...
				<th>进度插入时间</th>
				<td><input type="text" name="create_time" value="<?php echo to_date($output['borrowProgress']['create_time']);?>" onclick="$.calendar({format:'yyyy-MM-dd HH:mm:ss'});" class="date_time_picker"></td>
			</tr>
			<tr>
				<th>是否有效</th>
				<td>
