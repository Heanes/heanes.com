...
<form action="<?php echo BASE_URL.'index.php?act=borrowProgress&op=insert';?>" method="post" class="input-condensed" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		...
		<tr>
			<th>内部ID</th>
			<td><input type="text" name="progress_id" readonly value="<?php echo $output['lastID'];?>"></td>
			<th>贷款进行状态</th>
			<td><input type="text" name="status" value=""></td>
		</tr>
		<tr>
			<th>业务主ID</th>
			<td><input type="text" name="jk_id" value="" style="width:60%;"></td>
			<th>操作人ID</th>
			<td><input type="text" name="actor_user_id" value="" style="width:60%;"></td>
		</tr>
		<tr>
			<th>处理原因</th>
