<form action="<?php echo BASE_URL;?>index.php?act=WareAttribute&op=insert" method="post" class="input-condensed submitform" enctype="multipart/form-data">
	<table class="table table-striped table-condensed table-data-edit">
		<thead>
			<tr>
				<td colspan="4">添加物品属性</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td><textarea class="editor_id1" name="attribute_name"></textarea>
