...
$_LANG['cfg_name']['phone_400'] = '400客服电话';//后来添加  by 方刚 2014-11-14 11:27:52
$_LANG['cfg_name']['show_top_category_ads'] = '商品分类封面广告页功能';
$_LANG['cfg_range']['show_top_category_ads']['1'] = '开启';
$_LANG['cfg_range']['show_top_category_ads']['0'] = '关闭';//后来添加  by 方刚 2014-11-17 15:27:35
$_LANG['cfg_desc']['show_top_category_ads'] = '开启此功能，前台浏览某个分类时显示分类的封面样式，适合于做活动或广告推广时开启';
$_LANG['cfg_name']['goods_cat_smallest_num_show'] = '商品分类显示最小个数';
$_LANG['cfg_desc']['goods_cat_smallest_num_show'] = '如果某分类下商品个数小于此数，则显示其父分类下所有商品，并且重复此操作';

$_LANG['cfg_name']['show_fake_goods_sold_num'] = '商品销量显示';//后来添加 by 方刚 2014-11-25 16:42:29
$_LANG['cfg_range']['show_fake_goods_sold_num']['0'] = '不显示';
$_LANG['cfg_range']['show_fake_goods_sold_num']['1'] = '显示实际销量';
$_LANG['cfg_range']['show_fake_goods_sold_num']['2'] = '显示自定义销量';
$_LANG['cfg_desc']['show_fake_goods_sold_num'] = '显示自定义销量会自动加上实际销量';
...
/* 开发者模式 */
$_LANG['cfg_name']['develop_mode'] = '开发者模式（显示运行错误信息）';
$_LANG['cfg_range']['develop_mode']['1'] = '开启';
$_LANG['cfg_range']['develop_mode']['0'] = '关闭';
